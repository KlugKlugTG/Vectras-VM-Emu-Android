    ...
    public static String neededPkgs() {
        if (DeviceUtils.isArm()) {
            return "sudo bash aria2 tar dwm xterm libslirp libslirp-dev pulseaudio-dev glib-dev pixman-dev zlib-dev spice-dev" +
                    ...
                    " mesa-dri-gallium mesa-vulkan-swrast vulkan-loader vulkan-tools mesa-utils mesa-egl mesa-gbm mesa-vulkan-ati mesa-vulkan-broadcom mesa-vulkan-freedreno mesa-vulkan-panfrost" +
